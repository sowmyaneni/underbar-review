  ...
  describe('Part I', function() {
    ...
    describe('first', function() {
      ...
      it('should return empty array if zero is passed in as the index', function() {
        ...
        // equal means strictly equal which is comparing the same object to itself. If we use 
        // strictly equal below, test fails
        // eql means deeply equal which compares if every property of the 2 objects are exactly the same.
